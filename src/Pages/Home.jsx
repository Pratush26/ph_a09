    ...
    return (
        <main>
            <section className="grid grid-cols-1 md:grid-cols-2 pt-10 md:pt-0 items-center-safe md:items-end-safe justify-items-center-safe md:justify-items-end-safe bg-stone-300 md:gap-2">
                <div className="flex flex-col h-full items-center justify-center text-center gap-4 w-11/12 my-2">
                    ...
                    <Link to='/plants' className={`bg-emerald-600 text-gray-100 font-semibold w-fit mx-auto px-4 py-2 rounded-full m-2 cursor-pointer hover:bg-emerald-700 transition-colors duration-100 transition-discrete ${state === "idle" && "animate-[strggr_1.6s_ease-in-out]"}`}>Shop now</Link>
                </div>
            ...
            <Slider />
            <section className="text-center my-28 space-y-5" >
            ...
            <PlantsTips />
            <section className="text-center grid grid-cols-1 lg:grid-cols-[35%_65%] gap-6 w-11/12 mx-auto my-6 place-content-center" >
                ...
                <aside className="grid grid-cols-1 sm:grid-cols-2 place-content-center text-white gap-4 w-3/4 mx-auto" >
                    {
                        experts.map(e => (
                            <div key={e.expertId} className="bg-emerald-800 shadow-lg/50 shadow-emerald-950 rounded-2xl" >
                                ...
                                <div className="flex flex-col gap-1 items-start text-start px-3 text-wrap py-2 font-medium">
                                    ...
                                    <p className="text-sm font-extralight text-gray-200">{e.description}</p>
                                </div>
                            </div>
                        ))
                    }
